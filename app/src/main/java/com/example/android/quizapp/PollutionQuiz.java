...
public class PollutionQuiz extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doubleArray[1] = getResources().getStringArray(R.array.Question11);
        doubleArray[2] = getResources().getStringArray(R.array.Question12);
        doubleArray[3] = getResources().getStringArray(R.array.Question13);
        doubleArray[4] = getResources().getStringArray(R.array.Question14);
        doubleArray[5] = getResources().getStringArray(R.array.Question15);
        doubleArray[6] = getResources().getStringArray(R.array.Question16);
        doubleArray[7] = getResources().getStringArray(R.array.Question17);
        doubleArray[8] = getResources().getStringArray(R.array.Question18);
        doubleArray[9] = getResources().getStringArray(R.array.Question19);
        doubleArray[10] = getResources().getStringArray(R.array.Question20);
        ...
        textviewedit.setOnKeyListener(new OnKeyListener() {
    ...
    /**
     * Saves the current state (score, question number, state of checkboxes and radio buttons, visibility of control buttons and wrong correct images with texts)
     * to avoid data loss in case of screen rotation.
     */
    @Override
    ...
    /**
     * Restores the current state (score, question number, state of checkboxes and radio buttons, visibility of control buttons and wrong correct images with texts)
     * to avoid data loss in case of screen rotation.
     */
    ...
    public void checkboxOnClick(View view) {
        ...
        if (checkbox1.isChecked()) {
            ...
            checkbox1.setTextColor(getResources().getColor(R.color.green));
    ...
    public void setTextViewEdit() {
        ...
        if (editAnswer.equals(getString(R.string.pollution_q9_3))) {

            textquestion3.setTextColor(getResources().getColor(R.color.green));
            ...
            if (editAnswer.equals(getString(R.string.pollution_q9_1))) {

                textquestion1.setTextColor(getResources().getColor(R.color.red));
            ...
            if (editAnswer.equals(getString(R.string.pollution_q9_2))) {
            ...
            if (editAnswer.equals(getString(R.string.pollution_q9_4))) {
    ...
    private String finalmessage(int score) {
        ...
        if (score < 5) {
            ...
            message += getString(R.string.message13);
            message += getString(R.string.message8);
            return message;
        }
    }
